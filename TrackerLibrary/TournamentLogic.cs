...
namespace TrackerLibrary
{
    ...
    {
        // order our list of teams at random
        // check if it's big enough, if not add byes
        // create first round of matchups
        // create every round after that (divide by 2)(8 matchups - 4 - 2 - 1)
        ...
        private static void MarkWinnersInMatchups(List<MatchupModel> models)
        {
            ...
            foreach (MatchupModel m in models)
            {
                ...
                if (greaterWins == "0")
                {
                    ...
                    {
                        throw new Exception("No ties allowed");
                    }
                }
                else
                {
